...
#       sudo echo "POSTGRES_PASSWORD=${random_password.db_user_password[count.index].result}" >> /home/nologinusername/myapp/.env
#       sudo echo "POSTGRES_USERNAME=${google_sql_user.db_user[count.index].name}" >> /home/nologinusername/myapp/.env
#       sudo echo "POSTGRES_DATABASE=${google_sql_database.database[count.index].name}" >> /home/nologinusername/myapp/.env
#       sudo echo "POSTGRES_HOST=${google_sql_database_instance.postgres_instance[count.index].private_ip_address}" >> /home/nologinusername/myapp/.env
#       sudo echo "PUBSUB_INTERACTION=true" >> /home/nologinusername/myapp/.env
#       sudo echo "GCP_PROJECT_ID=${var.project_id}" >> /home/nologinusername/myapp/.env
#       sudo echo "PUBSUB_TOPIC_NAME=${google_pubsub_topic.verify_email_topic[count.index].name}" >> /home/nologinusername/myapp/.env

#       sudo chown -R "nologinusername":"nologinusername" "/home/nologinusername/myapp/.env"
#       sudo chmod -R 755 /home/nologinusername/myapp/.env
